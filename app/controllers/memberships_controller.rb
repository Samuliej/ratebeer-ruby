class MembershipsController < ApplicationController
  ...
  def show
    @membership.user = User.find(@membership.user_id)
    @membership.beer_club = BeerClub.find(@membership.beer_club_id)
  end
  ...
  def create
    ...
    @membership.beer_club = BeerClub.find(params[:membership][:beer_club_id])
